...
$(function(){
	...
	$('.nav-lglogin, .slider1_loginbtn').on('click',function(event) {
		event.stopPropagation()
		if(window.navigator.userAgent.indexOf('Chrome') == -1){
			if(confirm('您的浏览器暂不支持微页制作，建议使用谷歌浏览器、搜狗浏览器、360浏览器。点确定自动跳转到谷歌浏览器下载页面。')){
				window.open('http://www.baidu.com/s?word=%E8%B0%B7%E6%AD%8C%E6%B5%8F%E8%A7%88%E5%99%A8&tn=91293447_hao_pg&ie=utf-8');
			}
		}
